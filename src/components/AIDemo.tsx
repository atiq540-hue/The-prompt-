  ...
  return (
    <section className="py-24 bg-slate-800 border-y border-slate-700">
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 bg-slate-700 p-5 sm:p-8 rounded-[32px] border border-slate-600 shadow-2xl">
          <div className="space-y-6">
            <div className="aspect-square rounded-2xl bg-slate-800 border-2 border-dashed border-slate-600 flex flex-col items-center justify-center relative overflow-hidden group">
              {image ? (
                <>
            ...
            <div className="space-y-4">
              <div className="relative">
                <textarea
                  ...
                  className="w-full bg-slate-800 border border-slate-600 rounded-2xl px-5 py-4 text-white focus:outline-none focus:border-sky-500 transition-colors h-32 resize-none text-base"
                />
          ...
          <div className="aspect-square rounded-2xl bg-slate-800 border border-slate-700 flex flex-col items-center justify-center relative overflow-hidden">
